...
namespace Q42.WinRT.Data
{
    ...
    public class CacheObject
    {
        ...
        public bool IsValid
        {
            get { return ExpireDateTime == null || ExpireDateTime.Value > DateTime.Now; }
        }
    }
    ...
    public static class DataCache
    {
            ...
            StorageSerializer serializerType = StorageSerializer.JSON)
        {
            ...
            try
            {
                ...
                //Delete old value
                //Do not await
                await Delete(key, serializerType);
            }
            catch
            {
        ...
        /// <param name="serializerType">JSON or XML serializer</param>
        /// <returns></returns>
        public static async Task Delete(string key, StorageSerializer serializerType = StorageSerializer.JSON)
        {
