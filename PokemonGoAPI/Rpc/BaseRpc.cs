...
namespace PokemonGo.RocketAPI.Rpc
{
    public class BaseRpc
    {
        ...
        protected RequestBuilder RequestBuilder => new RequestBuilder(_client.AuthToken, _client.AuthType, _client.CurrentLatitude, _client.CurrentLongitude, _client.CurrentAltitude, _client.DeviceInfo, _client.AuthTicket);
